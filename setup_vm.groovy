...
def setup_vm(vm, vm_node) {
    ...
    def secret = jenkins.model.Jenkins.getInstance().getComputer(vm_node).getJnlpMac()
    ...
    this.vmgmt.run_script_on_vm('vmuser', 'password', machine.vmxurl, "", 
        "java -Dhudson.util.ProcessTree.disable=true -jar \"C:\\Users\\vmuser\\Desktop\\agent.jar\" -jnlpUrl http://${masterIP}:8080/computer/${vm_node}/slave-agent.jnlp -secret ${secret} -workDir \"C:\\Users\\vmuser\"", false)
