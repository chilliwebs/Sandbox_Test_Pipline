...
def setup_vm(node_name) {
    ...
    def secret = jenkins.model.Jenkins.getInstance().getComputer(node_name).getJnlpMac()
    ...
    this.vmgmt.run_script_on_vm('vmuser', 'password', machine.vmxurl, "", 
        "java -Dhudson.util.ProcessTree.disable=true -jar \"C:\\Users\\vmuser\\Desktop\\agent.jar\" -jnlpUrl http://${masterIP}:8080/computer/${node_name}/slave-agent.jnlp -secret ${secret} -workDir \"C:\\User\\vmuser\"", false)
