...
def setup_vm() {
    ...
    this.vmgmt.run_script_on_vm('vmuser', 'password', machine.vmxurl, "", 
        "start cmd \"/k %JAVA_HOME%/bin/java\" -Dhudson.util.ProcessTree.disable=true -jar C:\\Users\\vmuser\\Desktop\\agent.jar -jnlpUrl http://${masterIP}:8080/computer/${env.vmnod}/slave-agent.jnlp -secret ${secret} -workDir C:\\Users\\vmuser", false, true)
